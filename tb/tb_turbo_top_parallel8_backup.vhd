...
entity tb_turbo_top_parallel8_backup is
  generic (
    G_VEC_PATH       : string := "sim_vectors/lte_frame_input_vectors.txt";
    G_IO_TRACE_PATH  : string := "tb_turbo_top_parallel8_backup_io_trace.txt";
    G_REPORT_PATH    : string := "tb_turbo_top_parallel8_backup_report.txt";
    G_FINAL_LLR_PATH : string := "tb_turbo_top_parallel8_backup_final_llrs.txt"
  );
end entity;

architecture sim of tb_turbo_top_parallel8_backup is
...
begin
  ...
  begin
    ...
    write(l, string'("# turbo_top_parallel8_backup IO trace"));
    ...
    report "tb_turbo_top_parallel8_backup passed with out_cnt=" & integer'image(out_cnt) &
