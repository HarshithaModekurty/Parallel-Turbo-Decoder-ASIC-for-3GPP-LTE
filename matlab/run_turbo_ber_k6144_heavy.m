%RUN_TURBO_BER_K6144_HEAVY Heavier BER run at K=6144.
%
...
baseCfg.numFrames = 16;
baseCfg.maxBitErrors = 2500;
baseCfg.maxFrameErrors = 16;
baseCfg.seed = 12345;
...
plotPath = fullfile(resultsDir, "ber_fer_k6144_halfiter11_heavy.png");
csvPath = fullfile(resultsDir, "ber_fer_k6144_halfiter11_heavy.csv");
