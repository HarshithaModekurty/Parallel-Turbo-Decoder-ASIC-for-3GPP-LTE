...
\title{Design and Implementation of a Parallel Turbo-Decoder ASIC for 3GPP-LTE}
...
\begin{figure*}[t]
\centering
\subfloat[Timing summary extracted from \texttt{single\_siso\_timing\_report.txt}.]{\includegraphics[width=0.48\textwidth]{figures/single_siso_timing_visual.png}\label{fig:single_siso_timing_visual}}
\hfill
\subfloat[Power summary extracted from \texttt{single\_siso\_power\_1.txt}.]{\includegraphics[width=0.48\textwidth]{figures/single_siso_power_visual.png}\label{fig:single_siso_power_visual}}
